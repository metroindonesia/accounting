...
import postcss from 'rollup-plugin-postcss'; // <--- Tambahkan ini
import cssnano from 'cssnano'; // <--- Tambahkan ini
import atImport from 'postcss-import'; // <--- Tambahkan ini
...
export default [
...

	{
		...
		plugins: [
			...
			postcss({
				extract: `agingtype-${newVersionNumber}.min.css`, // Nama file output CSS
