...
-- =============================================
-- ADD _timestamp
alter table public."periode" add _timestamp timestamp with time zone not null default now();
comment on column public."periode"._timestamp is 'data timestamp';
...
-- INDEX
-- =============================================
DROP INDEX IF EXISTS public.idx$public$periode$_timestamp;
CREATE INDEX idx$public$periode$_timestamp ON public.periode (_timestamp);
