...
import * as Ext from './agingtype-ext.mjs'
...
export async function init(self, args) {
	...
	// export async function agingtypeHeaderEdit_init(self, CurrentState)
	const fn_init_name = 'agingtypeHeaderEdit_init'
...
export async function openSelectedData(self, params) {
	...
	try {
		...
		// export async function agingtypeHeaderEdit_isEditDisabled(self, data)
...
async function  frm_locked(self, evt) {
	...
	// export function agingtypeHeaderEdit_formLocked(self, frm, CurrentState) {}
...
async function  frm_unlocked(self, evt) {
	...
	// export function agingtypeHeaderEdit_formUnlocked(self, frm, CurrentState) {}
...
async function btn_new_click(self, evt) {
	...
	try {
		...
		if (typeof fn_newdata === 'function') {
			// export async function agingtypeHeaderEdit_newData(self, datainit, frm) {}
...
async function btn_save_click(self, evt) {
	...
	// Extender Saving
	// export async function agingtypeHeaderEdit_dataSaving(self, dataToSave, frm, args) {}
	...
	try {
		...
		if (typeof fn_datasaved === 'function') {
			// export async function agingtypeHeaderEdit_dataSaved(self, data, frm) {}
...
async function btn_about_click(self, evt) {
	...
	pageHelper.openSection(self, 'fAbout-section', params, async ()=>{
		...
		if ( document.getElementById('fAbout-section-footer') == null) {
			...
			divFooter.innerHTML = 'This module is generated by fgta5 generator at 2 Feb 2026 16:56'
