...
const TitleWhenNew = 'New Business Case'
const TitleWhenView = 'View Business Case'
const TitleWhenEdit = 'Edit Business Case'
...
async function btn_about_click(self, evt) {
	...
	pageHelper.openSection(self, 'fAbout-section', params, async ()=>{
		...
		AboutSection.Title = 'About Business Case'
		...
		if ( document.getElementById('fAbout-section-footer') == null) {
			...
			divFooter.innerHTML = 'This module is generated by fgta5 generator at 7 Feb 2026 10:06'
