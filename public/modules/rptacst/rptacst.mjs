...
import * as reportPage from './rptacstPage.mjs'  // todo: sesuaikan
...
const obj_partner = new $fgta5.Combobox('obj_partner')
...
export default class extends Module {
	...
	async main(args = {}) {
		...
		try {
			...
			obj_partner.addEventListener('selecting', (evt) => obj_partner_selecting(evt))
...
async function obj_partner_selecting(evt) {
