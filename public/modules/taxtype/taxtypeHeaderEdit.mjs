...
import * as Ext from './taxtype-ext.mjs'
...
const obj_taxtype_isdisabled = frm.Inputs['taxtypeHeaderEdit-obj_taxtype_isdisabled']
const obj_taxtype_name = frm.Inputs['taxtypeHeaderEdit-obj_taxtype_name']
const obj_taxtype_model = frm.Inputs['taxtypeHeaderEdit-obj_taxtype_model']
const obj_taxtype_value = frm.Inputs['taxtypeHeaderEdit-obj_taxtype_value']
const obj_bill_coa_id = frm.Inputs['taxtypeHeaderEdit-obj_bill_coa_id']	
...
export async function init(self, args) {
	...
	const fn_init_name = 'taxtypeHeaderEdit_init'
	...
	obj_bill_coa_id.addEventListener('selecting', async (evt)=>{
		...
		const fn_selecting_name = 'obj_bill_coa_id_selecting'
		const fn_selecting = Extender[fn_selecting_name]
		if (typeof fn_selecting === 'function') {
			// create function di Extender (jika perlu):
			// export async function obj_bill_coa_id_selecting(self, obj_bill_coa_id, frm, evt) {}
			fn_selecting(self, obj_bill_coa_id, frm, evt)
		} else {
			// default selecting
			...
			// export function obj_bill_coa_id_selecting_criteria(self, obj_bill_coa_id, frm, criteria, sort, evt) {}
			const fn_selecting_criteria_name = 'obj_bill_coa_id_selecting_criteria'
			const fn_selecting_criteria = Extender[fn_selecting_criteria_name]
			if (typeof fn_selecting_criteria === 'function') {
				fn_selecting_criteria(self, obj_bill_coa_id, frm, criteria, sort, evt)
			}
...
export async function openSelectedData(self, params) {
	...
	try {
		...
		// export async function taxtypeHeaderEdit_isEditDisabled(self, data)
...
async function  frm_locked(self, evt) {
	...
	// export function taxtypeHeaderEdit_formLocked(self, frm, CurrentState) {}
...
async function  frm_unlocked(self, evt) {
	...
	// export function taxtypeHeaderEdit_formUnlocked(self, frm, CurrentState) {}
...
async function btn_new_click(self, evt) {
	...
	try {
		...
		if (typeof fn_newdata === 'function') {
			// export async function taxtypeHeaderEdit_newData(self, datainit, frm) {}
...
async function btn_save_click(self, evt) {
	...
	// Extender Saving
	// export async function taxtypeHeaderEdit_dataSaving(self, dataToSave, frm, args) {}
	...
	try {
		...
		if (typeof fn_datasaved === 'function') {
			// export async function taxtypeHeaderEdit_dataSaved(self, data, frm) {}
...
async function btn_about_click(self, evt) {
	...
	pageHelper.openSection(self, 'fAbout-section', params, async ()=>{
		...
		if ( document.getElementById('fAbout-section-fdescr') == null) {
			...
			divDescr.innerHTML = 'daftar tipe pajak'
		...
		if ( document.getElementById('fAbout-section-footer') == null) {
			...
			divFooter.innerHTML = 'This module is generated by fgta5 generator at 25 Feb 2026 10:34'
