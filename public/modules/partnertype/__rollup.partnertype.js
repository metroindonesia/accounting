 ...
 *
 * This module is generated by fgta5 generator at 2 Feb 2026 14:45
 ************************************************************************/
...
const banner = `partnertype
*
* build at ${currentdate}
`

const filename = `version.txt`;
const filepath = join('public/modules/partnertype', filename);

/* Hapus versi sebelumnya */
if (await isExists(filepath)) {
	const previousVersionNumber = await readFile(filepath, 'utf8');
	const previousFile = `public/modules/partnertype/partnertype-${previousVersionNumber}.min.mjs`
...
export default {
	input: "public/modules/partnertype/partnertype.mjs", // File utama yang menjadi entry point
	output: {
		file: `public/modules/partnertype/partnertype-${newVersionNumber}.min.mjs`, // Lokasi output file hasil bundle
