...
ALTER TABLE public."itemclassstruct" DROP CONSTRAINT fk$public$itemclassstruct$itemclass_id;
...
ALTER TABLE public."itemclassstruct"
	ADD CONSTRAINT fk$public$itemclassstruct$itemclass_id
	FOREIGN KEY (itemclass_id)
	REFERENCES public."itemclass"(itemclass_id);


-- Add As Index, drop dulu jika sudah ada
DROP INDEX IF EXISTS public.idx_fk$public$itemclassstruct$itemclass_id;
CREATE INDEX idx_fk$public$itemclassstruct$itemclass_id ON public."itemclassstruct"(itemclass_id);	
...
alter table public."itemclassstruct"
	drop constraint uq$public$itemclassstruct$itemclassstruct_pair;
	

-- Add unique index 
alter table  public."itemclassstruct"
	add constraint uq$public$itemclassstruct$itemclassstruct_pair unique (itemclass_id, struct_id); 
