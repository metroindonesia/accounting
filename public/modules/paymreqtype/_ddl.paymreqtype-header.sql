...
-- =============================================
-- ADD _timestamp
alter table public."paymreqtype" add _timestamp timestamp with time zone not null default now();
comment on column public."paymreqtype"._timestamp is 'data timestamp';
...
-- INDEX
-- =============================================
DROP INDEX IF EXISTS public.idx$public$paymreqtype$_timestamp;
CREATE INDEX idx$public$paymreqtype$_timestamp ON public.paymreqtype (_timestamp);
