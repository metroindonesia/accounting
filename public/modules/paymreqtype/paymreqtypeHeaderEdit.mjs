...
const TitleWhenNew = 'New Tipe Payment Request'
const TitleWhenView = 'View Tipe Payment Request'
const TitleWhenEdit = 'Edit Tipe Payment Request'
...
const obj_paymreqtype_isdisabled = frm.Inputs['paymreqtypeHeaderEdit-obj_paymreqtype_isdisabled']
...
const obj_hasffl = frm.Inputs['paymreqtypeHeaderEdit-obj_hasffl']
const obj_fflismandatory = frm.Inputs['paymreqtypeHeaderEdit-obj_fflismandatory']
const obj_hasbc = frm.Inputs['paymreqtypeHeaderEdit-obj_hasbc']
...
export async function init(self, args) {
	...
	// export async function paymreqtypeHeaderEdit_init(self, CurrentState)
	const fn_init_name = 'paymreqtypeHeaderEdit_init'
...
export async function openSelectedData(self, params) {
	...
	try {
		...
		// export async function paymreqtypeHeaderEdit_isEditDisabled(self, data)
...
async function btn_about_click(self, evt) {
	...
	pageHelper.openSection(self, 'fAbout-section', params, async ()=>{
		...
		AboutSection.Title = 'About Tipe Payment Request'
		...
		if ( document.getElementById('fAbout-section-footer') == null) {
			...
			divFooter.innerHTML = 'This module is generated by fgta5 generator at 25 Feb 2026 13:16'
