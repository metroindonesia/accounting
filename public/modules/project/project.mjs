...
import * as projectHeaderList from './projectHeaderList.mjs' 
import * as projectHeaderEdit from './projectHeaderEdit.mjs' 
import * as Extender from './project-ext.mjs'
...
export default class extends Module {
	...
	async main(args={}) {
		...
		try {
			...
			await Promise.all([ 
				projectHeaderList.init(self, args), 
				projectHeaderEdit.init(self, args), 
			...
			const modNameList = ['projectHeaderEdit']
...
async function render(self) {
	try {
		...
		// Setup Icon
		Crsl.setIconUrl('public/modules/project/project.svg')
		...
		// project-ext.mjs, export function extendPage(self) {} 
