 ...
 *
 * usage:
 * npx rollup -c ./public/modules/project/__rollup.project.js
 *
 * This module is generated by fgta5 generator at 2 Feb 2026 13:04
 ************************************************************************/
...
const filepath = join('public/modules/project', filename);

/* Hapus versi sebelumnya */
if (await isExists(filepath)) {
	const previousVersionNumber = await readFile(filepath, 'utf8');
	const previousFile = `public/modules/project/project-${previousVersionNumber}.min.mjs`
...
export default {
	input: "public/modules/project/project.mjs", // File utama yang menjadi entry point
	output: {
		file: `public/modules/project/project-${newVersionNumber}.min.mjs`, // Lokasi output file hasil bundle
