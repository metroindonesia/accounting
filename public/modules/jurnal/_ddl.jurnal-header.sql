...
-- =============================================
-- ADD _timestamp
alter table public."jurnal" add _timestamp timestamp with time zone not null default now();
comment on column public."jurnal"._timestamp is 'data timestamp';
...
-- INDEX
-- =============================================
DROP INDEX IF EXISTS public.idx$public$jurnal$_timestamp;
CREATE INDEX idx$public$jurnal$_timestamp ON public.jurnal (_timestamp);
