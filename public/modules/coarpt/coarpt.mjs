...
import * as coarptHeaderList from './coarptHeaderList.mjs' 
import * as coarptHeaderEdit from './coarptHeaderEdit.mjs' 
import * as Extender from './coarpt-ext.mjs'
...
export default class extends Module {
	...
	async main(args={}) {
		...
		try {
			...
			await Promise.all([ 
				coarptHeaderList.init(self, args), 
				coarptHeaderEdit.init(self, args), 
			...
			const modNameList = ['coarptHeaderEdit']
...
async function render(self) {
	try {
		...
		// Setup Icon
		Crsl.setIconUrl('public/modules/coarpt/coarpt.svg')
		...
		// coarpt-ext.mjs, export function extendPage(self) {} 
