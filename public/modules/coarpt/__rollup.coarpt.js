 ...
 *
 * usage:
 * npx rollup -c ./public/modules/coarpt/__rollup.coarpt.js
 *
 * This module is generated by fgta5 generator at 2 Feb 2026 17:08
 ************************************************************************/
...
const filepath = join('public/modules/coarpt', filename);

/* Hapus versi sebelumnya */
if (await isExists(filepath)) {
	const previousVersionNumber = await readFile(filepath, 'utf8');
	const previousFile = `public/modules/coarpt/coarpt-${previousVersionNumber}.min.mjs`
...
export default {
	input: "public/modules/coarpt/coarpt.mjs", // File utama yang menjadi entry point
	output: {
		file: `public/modules/coarpt/coarpt-${newVersionNumber}.min.mjs`, // Lokasi output file hasil bundle
