 ...
 *
 * This module is generated by fgta5 generator at 2 Feb 2026 17:42
 ************************************************************************/
...
const filepath = join('public/modules/curr', filename);

/* Hapus versi sebelumnya */
if (await isExists(filepath)) {
	const previousVersionNumber = await readFile(filepath, 'utf8');
	const previousFile = `public/modules/curr/curr-${previousVersionNumber}.min.mjs`
...
export default {
	input: "public/modules/curr/curr.mjs", // File utama yang menjadi entry point
	output: {
		file: `public/modules/curr/curr-${newVersionNumber}.min.mjs`, // Lokasi output file hasil bundle
