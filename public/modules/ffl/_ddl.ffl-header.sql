...
-- =============================================
-- ADD _timestamp
alter table public."ffl" add _timestamp timestamp with time zone not null default now();
comment on column public."ffl"._timestamp is 'data timestamp';
...
-- INDEX
-- =============================================
DROP INDEX IF EXISTS public.idx$public$ffl$_timestamp;
CREATE INDEX idx$public$ffl$_timestamp ON public.ffl (_timestamp);
