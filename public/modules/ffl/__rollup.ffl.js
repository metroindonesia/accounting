 ...
 *
 * usage:
 * npx rollup -c ./public/modules/ffl/__rollup.ffl.js
 *
...
const filepath = join('public/modules/ffl', filename);

/* Hapus versi sebelumnya */
if (await isExists(filepath)) {
	const previousVersionNumber = await readFile(filepath, 'utf8');
	const previousFile = `public/modules/ffl/ffl-${previousVersionNumber}.min.mjs`
...
export default {
	input: "public/modules/ffl/ffl.mjs", // File utama yang menjadi entry point
	output: {
		file: `public/modules/ffl/ffl-${newVersionNumber}.min.mjs`, // Lokasi output file hasil bundle
