...
-- =============================================
-- ADD _timestamp
alter table public."jurnaltype" add _timestamp timestamp with time zone not null default now();
comment on column public."jurnaltype"._timestamp is 'data timestamp';
...
-- INDEX
-- =============================================
DROP INDEX IF EXISTS public.idx$public$jurnaltype$_timestamp;
CREATE INDEX idx$public$jurnaltype$_timestamp ON public.jurnaltype (_timestamp);
