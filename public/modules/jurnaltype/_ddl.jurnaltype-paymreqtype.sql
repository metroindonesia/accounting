...
-- =============================================
-- ADD _timestamp
alter table public."jurnaltypepaymreqtype" add _timestamp timestamp with time zone not null default now();
comment on column public."jurnaltypepaymreqtype"._timestamp is 'data timestamp';
...
-- INDEX
-- =============================================
DROP INDEX IF EXISTS public.idx$public$jurnaltypepaymreqtype$_timestamp;
CREATE INDEX idx$public$jurnaltypepaymreqtype$_timestamp ON public.jurnaltypepaymreqtype (_timestamp);
