...
const TitleWhenNew = 'New Order'
const TitleWhenView = 'View Order'
const TitleWhenEdit = 'Edit Order'
...
const ID = frm.Inputs['poHeaderEdit-ID']
const obj_pos_descr = frm.Inputs['poHeaderEdit-obj_pos_descr']	
...
async function btn_about_click(self, evt) {
	...
	pageHelper.openSection(self, 'fAbout-section', params, async ()=>{
		...
		AboutSection.Title = 'About Order'
		...
		if ( document.getElementById('fAbout-section-footer') == null) {
			...
			divFooter.innerHTML = 'This module is generated by fgta5 generator at 7 Feb 2026 17:57'
