 ...
 *
 * usage:
 * npx rollup -c ./public/modules/po/__rollup.po.js
 *
...
const filepath = join('public/modules/po', filename);

/* Hapus versi sebelumnya */
if (await isExists(filepath)) {
	const previousVersionNumber = await readFile(filepath, 'utf8');
	const previousFile = `public/modules/po/po-${previousVersionNumber}.min.mjs`
...
export default {
	input: "public/modules/po/po.mjs", // File utama yang menjadi entry point
	output: {
		file: `public/modules/po/po-${newVersionNumber}.min.mjs`, // Lokasi output file hasil bundle
