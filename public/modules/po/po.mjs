...
import * as poHeaderList from './poHeaderList.mjs' 
import * as poHeaderEdit from './poHeaderEdit.mjs' 
import * as Extender from './po-ext.mjs'
...
export default class extends Module {
	...
	async main(args={}) {
		...
		try {
			...
			await Promise.all([ 
				poHeaderList.init(self, args), 
				poHeaderEdit.init(self, args), 
			...
			const modNameList = ['poHeaderEdit']
...
async function render(self) {
	try {
		...
		// po-ext.mjs, export function extendPage(self) {} 
