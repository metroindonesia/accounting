 ...
 *
 * This module is generated by fgta5 generator at 2 Feb 2026 14:35
 ************************************************************************/
...
const filepath = join('public/modules/struct', filename);

/* Hapus versi sebelumnya */
if (await isExists(filepath)) {
	const previousVersionNumber = await readFile(filepath, 'utf8');
	const previousFile = `public/modules/struct/struct-${previousVersionNumber}.min.mjs`
...
export default {
	input: "public/modules/struct/struct.mjs", // File utama yang menjadi entry point
	output: {
		file: `public/modules/struct/struct-${newVersionNumber}.min.mjs`, // Lokasi output file hasil bundle
