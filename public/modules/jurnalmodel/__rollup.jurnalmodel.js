 ...
 *
 * usage:
 * npx rollup -c ./public/modules/jurnalmodel/__rollup.jurnalmodel.js
 *
...
const banner = `jurnalmodel
*
* build at ${currentdate}
`

const filename = `version.txt`;
const filepath = join('public/modules/jurnalmodel', filename);

/* Hapus versi sebelumnya */
if (await isExists(filepath)) {
	const previousVersionNumber = await readFile(filepath, 'utf8');
	const previousFile = `public/modules/jurnalmodel/jurnalmodel-${previousVersionNumber}.min.mjs`
...
export default {
	input: "public/modules/jurnalmodel/jurnalmodel.mjs", // File utama yang menjadi entry point
	output: {
		file: `public/modules/jurnalmodel/jurnalmodel-${newVersionNumber}.min.mjs`, // Lokasi output file hasil bundle
