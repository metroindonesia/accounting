...
import * as jurnalmodelHeaderList from './jurnalmodelHeaderList.mjs' 
import * as jurnalmodelHeaderEdit from './jurnalmodelHeaderEdit.mjs' 
import * as Extender from './jurnalmodel-ext.mjs'
...
export default class extends Module {
	...
	async main(args={}) {
		...
		self.Modules = { 
			jurnalmodelHeaderList, 
			jurnalmodelHeaderEdit, 
		}
		...
		try {
			...
			await Promise.all([ 
				jurnalmodelHeaderList.init(self, args), 
				jurnalmodelHeaderEdit.init(self, args), 
			...
			const modNameList = ['jurnalmodelHeaderEdit']
...
async function render(self) {
	try {
		...
		// jurnalmodel-ext.mjs, export function extendPage(self) {} 
