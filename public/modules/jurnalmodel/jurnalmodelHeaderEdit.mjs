...
const obj_jurnalmodel_printout = frm.Inputs['jurnalmodelHeaderEdit-obj_jurnalmodel_printout']
const obj_jurnalmodel_title = frm.Inputs['jurnalmodelHeaderEdit-obj_jurnalmodel_title']	
...
async function btn_about_click(self, evt) {
	...
	pageHelper.openSection(self, 'fAbout-section', params, async ()=>{
		...
		if ( document.getElementById('fAbout-section-footer') == null) {
			...
			divFooter.innerHTML = 'This module is generated by fgta5 generator at 24 Feb 2026 20:54'
