 ...
 *
 * usage:
 * npx rollup -c ./public/modules/txrowtype/__rollup.txrowtype.js
 *
...
const banner = `txrowtype
*
* build at ${currentdate}
`

const filename = `version.txt`;
const filepath = join('public/modules/txrowtype', filename);

/* Hapus versi sebelumnya */
if (await isExists(filepath)) {
	const previousVersionNumber = await readFile(filepath, 'utf8');
	const previousFile = `public/modules/txrowtype/txrowtype-${previousVersionNumber}.min.mjs`
...
export default {
	input: "public/modules/txrowtype/txrowtype.mjs", // File utama yang menjadi entry point
	output: {
		file: `public/modules/txrowtype/txrowtype-${newVersionNumber}.min.mjs`, // Lokasi output file hasil bundle
