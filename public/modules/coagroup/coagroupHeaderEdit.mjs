...
import * as Ext from './coagroup-ext.mjs'
...
const obj_coarpt_id = frm.Inputs['coagroupHeaderEdit-obj_coarpt_id']
...
const obj_coagroup_pathid = frm.Inputs['coagroupHeaderEdit-obj_coagroup_pathid']
...
export async function init(self, args) {
	...
	// export async function coagroupHeaderEdit_init(self, CurrentState)
	const fn_init_name = 'coagroupHeaderEdit_init'
	...
	obj_coagroup_parent.addEventListener('selected', (evt)=>{
		
		evt.detail.CurrentState = CurrentState
		
		const fn_selected_name = 'obj_coagroup_parent_selected'
		const fn_selected = Extender[fn_selected_name]
		if (typeof fn_selected === 'function') {
			// create function di Extender:
			// export async function obj_coagroup_parent_selected(self, obj_coagroup_parent, frm, evt) {}
			fn_selected(self, obj_coagroup_parent, frm, evt)
		} else {	
			console.warn('Extender.obj_coagroup_parent_selected is not implemented')
		}		
	})
	...
	obj_coagroup_parent.addEventListener('selecting', async (evt)=>{
		...
		if (typeof fn_selecting === 'function') {
			...
			const fn_selecting_criteria = Extender[fn_selecting_criteria_name]
			if (typeof fn_selecting_criteria === 'function') {
				fn_selecting_criteria(self, obj_coagroup_parent, frm, criteria, sort, evt)
			}
...
export async function openSelectedData(self, params) {
	...
	try {
		...
		// export async function coagroupHeaderEdit_isEditDisabled(self, data)
...
async function  frm_locked(self, evt) {
	...
	// export function coagroupHeaderEdit_formLocked(self, frm, CurrentState) {}
...
async function  frm_unlocked(self, evt) {
	...
	// export function coagroupHeaderEdit_formUnlocked(self, frm, CurrentState) {}
...
async function btn_new_click(self, evt) {
	...
	try {
		...
		if (typeof fn_newdata === 'function') {
			// export async function coagroupHeaderEdit_newData(self, datainit, frm) {}
...
async function btn_save_click(self, evt) {
	...
	// Extender Saving
	// export async function coagroupHeaderEdit_dataSaving(self, dataToSave, frm, args) {}
	...
	try {
		...
		if (typeof fn_datasaved === 'function') {
			// export async function coagroupHeaderEdit_dataSaved(self, data, frm) {}
...
async function btn_about_click(self, evt) {
	...
	pageHelper.openSection(self, 'fAbout-section', params, async ()=>{
		...
		if ( document.getElementById('fAbout-section-footer') == null) {
			...
			divFooter.innerHTML = 'This module is generated by fgta5 generator at 22 Feb 2026 07:35'
