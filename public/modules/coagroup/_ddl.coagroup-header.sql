...
-- =============================================
-- ADD _timestamp
alter table public."coagroup" add _timestamp timestamp with time zone not null default now();
comment on column public."coagroup"._timestamp is 'data timestamp';
...
-- INDEX
-- =============================================
DROP INDEX IF EXISTS public.idx$public$coagroup$_timestamp;
CREATE INDEX idx$public$coagroup$_timestamp ON public.coagroup (_timestamp);
