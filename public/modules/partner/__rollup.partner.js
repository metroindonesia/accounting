 ...
 *
 * This module is generated by fgta5 generator at 2 Feb 2026 15:26
 ************************************************************************/
...
const filepath = join('public/modules/partner', filename);

/* Hapus versi sebelumnya */
if (await isExists(filepath)) {
	const previousVersionNumber = await readFile(filepath, 'utf8');
	const previousFile = `public/modules/partner/partner-${previousVersionNumber}.min.mjs`
...
export default {
	input: "public/modules/partner/partner.mjs", // File utama yang menjadi entry point
	output: {
		file: `public/modules/partner/partner-${newVersionNumber}.min.mjs`, // Lokasi output file hasil bundle
