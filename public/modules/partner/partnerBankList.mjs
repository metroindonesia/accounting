...
export async function init(self, args) {
	...
	// export function bankList_addTableEvents(self, tbl) {}
	const fn_addTableEvents_name = 'bankList_addTableEvents'
...
export async function openList(self, params) {
	...
	const btn_edit = partnerBankEdit.getCurrentState().Actions.edit
...
async function listRows(self, criteria, offset, limit, sort) {
	...
	// export function bankList_dataLoad(self, criteria, sort, evt) {}
	const fn_dataLoad_name = 'bankList_dataLoad'
...
async function tbl_loadData(self, params={}) {
	...
	try {
		...
		// export function bankList_tableDataLoaded(self, tbl, result) {}
		const fn_name = 'bankList_tableDataLoaded'
