 ...
 *
 * This module is generated by fgta5 generator at 2 Feb 2026 12:22
 ************************************************************************/
...
const filepath = join('public/modules/site', filename);

/* Hapus versi sebelumnya */
if (await isExists(filepath)) {
	const previousVersionNumber = await readFile(filepath, 'utf8');
	const previousFile = `public/modules/site/site-${previousVersionNumber}.min.mjs`
...
export default {
	input: "public/modules/site/site.mjs", // File utama yang menjadi entry point
	output: {
		file: `public/modules/site/site-${newVersionNumber}.min.mjs`, // Lokasi output file hasil bundle
