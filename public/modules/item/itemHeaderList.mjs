...
const CurrentSectionId = Context.Sections.itemHeaderList
const CurrentSection = Crsl.Items[CurrentSectionId]
const CurrentState = {}

const tbl =  new $fgta5.Gridview('itemHeaderList-tbl')
const pnl_search = document.getElementById('itemHeaderList-pnl_search')
const btn_gridload = new $fgta5.ActionButton('itemHeaderList-btn_gridload') 

export const Section = CurrentSection
export const SearchParams = {}

export async function init(self, args) {
	console.log('initializing itemHeaderList ...')
	...
	try {
		...
		const obj_searchtext = document.getElementById('itemHeaderList-txt_searchtext')
		const btn_load = document.getElementById('itemHeaderList-btn_gridload')
		...
		// itemHeaderList-ext.mjs, export function initSearchParams(self, SearchParams) {} 
...
export function keyboardAction(self, actionName, evt) {
	if (actionName=='up') {
		...
		const itemHeaderEdit = self.Modules.itemHeaderEdit
		if (tbl.CurrentRow!=null) {
			itemHeaderEdit.Section.show({}, ()=>{
...
async function openRow(self, tr) {
	...
	const itemHeaderEdit = self.Modules.itemHeaderEdit
	itemHeaderEdit.clearForm(self, 'loading...')

	try {
		setCurrentRow(self, tr)
		CurrentState.SelectedRow.keyValue = keyvalue
		CurrentState.SelectedRow.key = key
		await itemHeaderEdit.openSelectedData(self, {key:key, keyvalue:keyvalue})

		// matikan atau nyalakan button prev/next sesuai kondisi
		setPagingButton(self, itemHeaderEdit)
...
function tbl_cellclick(self, evt) {
	...
	const itemHeaderEdit = self.Modules.itemHeaderEdit
	itemHeaderEdit.Section.show({}, (evt)=>{
		openRow(self, tr)
	})
...
async function tbl_loadData(self, params={}) {
	console.log('loading itemHeader data')
	console.log(params)
