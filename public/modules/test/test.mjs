...
import * as testHeaderList from './testHeaderList.mjs' 
import * as testHeaderEdit from './testHeaderEdit.mjs' 
import * as Extender from './test-ext.mjs'
...
export default class extends Module {
	...
	async main(args={}) {
		...
		try {
			...
			await Promise.all([ 
				testHeaderList.init(self, args), 
				testHeaderEdit.init(self, args), 
			...
			const modNameList = ['testHeaderEdit']
...
async function render(self) {
	try {
		...
		// test-ext.mjs, export function extendPage(self) {} 
