 ...
 *
 * This module is generated by fgta5 generator at 2 Feb 2026 13:00
 ************************************************************************/
...
const filepath = join('public/modules/unit', filename);

/* Hapus versi sebelumnya */
if (await isExists(filepath)) {
	const previousVersionNumber = await readFile(filepath, 'utf8');
	const previousFile = `public/modules/unit/unit-${previousVersionNumber}.min.mjs`
...
export default {
	input: "public/modules/unit/unit.mjs", // File utama yang menjadi entry point
	output: {
		file: `public/modules/unit/unit-${newVersionNumber}.min.mjs`, // Lokasi output file hasil bundle
