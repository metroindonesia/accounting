...
const headerTableName = 'public.paymtype' 	
...
export default class extends Api {
	...
	// extender call
	async execute(body) { return await paymtype_execute(this, body) }
...
async function paymtype_init(self, body) {
	...
	try {
		...
		if (typeof Extender.paymtype_init === 'function') {
			// export async function paymtype_init(self, initialData) {}
			await Extender.paymtype_init(self, initialData)
		}
...
async function paymtype_execute(self, body) {
	const { fnName } = body
	...
	if (typeof Extender[fnName] === 'function') {
		// export async function [fnName](self, db, body, paymtype_log) {}
		return await Extender[fnName](self, db, body, paymtype_log)
	} else {
