...
const headerTableName = 'public.periode' 	
...
export default class extends Api {
	...
	// extender call
	async execute(body) { return await periode_execute(this, body) }
...
async function periode_execute(self, body) {
	const { fnName } = body
	...
	if (typeof Extender[fnName] === 'function') {
		// export async function [fnName](self, db, body, periode_log) {}
		return await Extender[fnName](self, db, body, periode_log)
	} else {
