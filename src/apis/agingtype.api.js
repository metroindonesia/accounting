...
const headerTableName = 'public.agingtype' 	
...
export default class extends Api {
	...
	// extender call
	async execute(body) { return await agingtype_execute(this, body) }
...
async function agingtype_init(self, body) {
	...
	try {
		...
		if (typeof Extender.agingtype_init === 'function') {
			// export async function agingtype_init(self, initialData) {}
			await Extender.agingtype_init(self, initialData)
		}
...
async function agingtype_execute(self, body) {
	const { fnName } = body
	...
	if (typeof Extender[fnName] === 'function') {
		// export async function [fnName](self, db, body, agingtype_log) {}
		return await Extender[fnName](self, db, body, agingtype_log)
	} else {
